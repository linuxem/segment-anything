...
if os.path.isfile("images/truck.jpg") == False:
...
if os.path.isfile("images/groceries.jpg") == False:
   wget.download("https://raw.githubusercontent.com/facebookresearch/segment-anything/main/notebooks/images/groceries.jpg")
